  ...
  return (
    <div className="rounded-xl border border-gray-300 p-4 text-center space-y-4">
      ...
      <form className="flex space-x-4 justify-center items-center">
        ...
        <img src={`/imgs/flags/${homeTeam}.png`} alt="bandeira do pais" />

        <input
          className="bg-red-300/[0.20] text-center w-[55px] h-[55px] text-red-700 text-xl"
          max={10}
          type="number"
          name="homeTeamScore"
          ...
          disabled={disabled}
        />
        <span className="m-4 text-red-500 opacity-40">x</span>
        <input
          className="bg-red-300/[0.20] text-center w-[55px] h-[55px] text-red-700 text-xl"
          max={10}
          type="number"
          ...
          disabled={disabled}
        />
        <img src={`/imgs/flags/${awayTeam}.png`} alt="bandeira do pais" />
